...
`define AESL_DEPTH_InModel 1
`define AESL_DEPTH_OutModel0 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.CNN.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.CNN.autotvin_gmem1.dat"
...
`define AUTOTB_TVOUT_OutModel0_out_wrapc  "../tv/rtldatafile/rtl.CNN.autotvout_OutModel0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4393183;
parameter LENGTH_InModel = 1;
parameter LENGTH_OutModel0 = 1;
parameter LENGTH_Weights = 1;
parameter LENGTH_gmem0 = 6920;
parameter LENGTH_gmem1 = 62999;
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & control_r_write_data_finish;
...
reg end_InModel;
reg [31:0] size_InModel;
reg [31:0] size_InModel_backup;
reg end_Weights;
reg [31:0] size_Weights;
reg [31:0] size_Weights_backup;
reg end_OutModel0;
reg [31:0] size_OutModel0;
reg [31:0] size_OutModel0_backup;
...
reg dump_tvout_finish_OutModel0;

initial begin : dump_tvout_runtime_sign_OutModel0
    integer fp;
    dump_tvout_finish_OutModel0 = 0;
    fp = $fopen(`AUTOTB_TVOUT_OutModel0_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_OutModel0_out_wrapc);
    ...
    fp = $fopen(`AUTOTB_TVOUT_OutModel0_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_OutModel0_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
